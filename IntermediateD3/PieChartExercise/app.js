...
var colors = [
    ...
    "#bac78e", "#ddb092", "#ff9896", "#ffa48c", 
    "#ffaf82", "#ffbb78", "#e4bf9d", "#c9c3c3"
];
var quarterColors = ["#1f77b4", "#2ca02c", "#d62728", "#ff7f0c"];
...
function drawGraph(year) {
    ...
    var arcs = d3.pie()
                .value(d => d.births)
                .sort((a, b) => orderedMonths.indexOf(a.month)
                 - orderedMonths.indexOf(b.month));
